...
public class HomeRAdapter2 extends RecyclerBaseAdapter<HomeVO> {
    private String signUrl;
    public HomeRAdapter2(RecyclerView recyclerView) {
            ...
            public void onItemChildClick(ViewGroup viewGroup, View v, int i) {
                ...
                switch (v.getId()) {
                    ...
                    case R.id.type_07_tv:
                        ...
                        bundle.putString("url",HomeRAdapter2.this.getSignUrl());
                        mActivity.open(WebViewActivity.class,bundle,0);
                        break;
