...
import com.xiaojing.shop.adapter.OneShopLotteryedAdapter;
...
public class OneShopLotteryedActivity extends BaseActivity implements OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener, BGAOnRVItemClickListener {

    private AutoSwipeRefreshLayout mAutoSwipeRefreshLayout;
    private LuRecyclerView mRecyclerView;
    private OneShopLotteryedAdapter mAdapter;
    ...
    public void initView() {
        mBaseTitleTv.setText("本期已揭晓");
        mAutoSwipeRefreshLayout = getViewById(R.id.swipe_refresh_layout);
        mActivity.setSwipeRefreshLayoutColors(mAutoSwipeRefreshLayout);

        mRecyclerView = getViewById(R.id.recycler_view);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(mActivity));
        mAdapter = new OneShopLotteryedAdapter(mRecyclerView);
