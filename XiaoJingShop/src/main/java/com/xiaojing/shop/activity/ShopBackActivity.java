...
import com.xiaojing.shop.fragment.ShopBackFragment;
...
public class ShopBackActivity extends BaseActivity {
    private String[] mTitleDataList = {"退款", "退货"};
...
//            }
    ...
    public void initViewPagerData() {
        ...
        for (int i = 1; i <= mTitleDataList.length; i++) {
            ShopBackFragment fragment = (ShopBackFragment) ShopBackFragment.newInstance();
            fragment.setState(i);
