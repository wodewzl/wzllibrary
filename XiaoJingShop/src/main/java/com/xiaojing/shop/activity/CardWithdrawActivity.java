...
public class CardWithdrawActivity extends BaseActivity implements View.OnClickListener, PostCallback {
    ...
    public void initView() {
        ...
        Picasso.with(this).load(mPayTypeVO.getBank_image()).placeholder(R.drawable.img_default).into(mImg);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case 1:
                ...
                Picasso.with(this).load(mBlankImg).placeholder(R.drawable.img_default).into(mImg);
                break;
            default:
                break;
        }
