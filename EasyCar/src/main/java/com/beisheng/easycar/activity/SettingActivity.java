...
public class SettingActivity extends BaseActivity implements View.OnClickListener, PostCallback {
    ...
    public void initView() {
        ...
        mBt.setBackground(BaseCommonUtils.setBackgroundShap(this, 5, R.color.Car2, R.color.Car2));
...
//        mCacheTv.setText(mDataCleanUtil.getCacheSize(this, new File(FileUtil.getSaveFilePath(this, Constant.SDCARD_CACHE))));
    ...
    public void onClick(View v) {
        if (AppApplication.getInstance().getUserInfoVO() == null && v.getId() != R.id.layout_05 && v.getId() != R.id.layout_04&& v.getId() != R.id.layout_07&& v.getId() != R.id.layout_08) {
