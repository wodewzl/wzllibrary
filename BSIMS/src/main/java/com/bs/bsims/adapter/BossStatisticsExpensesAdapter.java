...
public class BossStatisticsExpensesAdapter extends BSBaseAdapter<BossStatisticsAttendanceVO> {
	private Context mContext;
	private String mMode = "1";

	public BossStatisticsExpensesAdapter(Context context) {
		super(context);
		mContext = context;
	}
	...
	public void sortList(List<BossStatisticsAttendanceVO> list) {
		Comparator comp = new Comparator() {
            ...
            public int compare(Object o1, Object o2) {
				...
				one = (int)Float.parseFloat(p1.getNum());
				two = (int)Float.parseFloat(p2.getNum());
				if (one < two) {
					return 1;
				} else if (one == two) {
					return 0;
