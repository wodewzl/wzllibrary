...
public class TwoTreeAdapterBk extends BaseExpandableListAdapter {
    private Context mContext;
    private List<String> groupArray;// 组列表
    private List<List<String>> childArray;// 子列表
    ItemOnClickCallback mCallback;

    public TwoTreeAdapterBk(Context context, List<String> groupArray, List<List<String>> childArray)
    {
    ...
    public View getChildView(final int groupPosition, final int childPosition,
        ...
        holder.tvName.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                mCallback.getType(groupPosition + "", childPosition + "");
            }
        });
        return convertView;
    }
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded,
        ...
        holder.parentName.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                mCallback.getType(groupPosition + "", "");
            }
        });
        return convertView;
    }
    ...
    public interface ItemOnClickCallback {
        public String getType(String parentPosition, String childPosition);
    }

    public void setDialogCallback(ItemOnClickCallback dialogcallback) {
