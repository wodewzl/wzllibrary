...
public class ImageManager2 {
    ...
    private static BSApplication myBsapp;
    ...
    public static ImageManager2 from(Context context) {
        ...
        if (myBsapp == null) {
            myBsapp = (BSApplication) context.getApplicationContext();
        }
        // if (myapp == null) {
        // // myapp = (OAGerneralApplication) context.getApplicationContext();
        // myapp = (BSApplication) context.getApplicationContext();
        // }

        if (imageManager == null) {
            imageManager = new ImageManager2(myBsapp);
    ...
    private byte[] loadByteArrayFromNetwork(String url) {
        ...
        try {
            ...
            HttpResponse response = HttpClientUtil.getHttpClient().execute(method);
    ...
    public String urlToFilePath(String url) {
        ...
        // 图片存取路径
        filePath.append(myBsapp.getCacheDir().toString()).append('/');
