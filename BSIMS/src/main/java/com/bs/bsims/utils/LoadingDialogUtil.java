...
import com.bs.bsims.interfaces.CommitCallback;
...
public class LoadingDialogUtil {
    ...
    private CommitCallback loadingDialogExecute;
     ...
     * @param loadingDialogExecute 需要实现LoadingDialogExecute类的三个方法
     */
    public LoadingDialogUtil(Context context, CommitCallback loadingDialogExecute) {
    ...
    private Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    loadingDialogExecute.commitSuccess();
                    break;
                case 1:
                    loadingDialogExecute.commitFailure();
                    break;
            }
    ...
    public void start() {
        ...
        thread = new Thread() {
            public void run() {
                boolean b = loadingDialogExecute.commit();
                if (b) {
