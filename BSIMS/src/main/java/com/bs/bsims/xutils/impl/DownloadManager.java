...
public final class DownloadManager {
    ...
    static {
        // 注册DownloadState在数据库中的值类型映�?        ColumnConverterFactory.registerColumnConverter(DownloadState.class, new DownloadStateConverter());
    }

    private static DownloadManager instance;

    private final static int MAX_DOWNLOAD_THREAD = 2; // 有效的�?范围[1, 3], 设置�?�? 可能阻塞图片加载.
    ...
    public synchronized void startDownload(String url, String label, String savePath,
        ...
        if (downloadInfo != null) {
            ...
            if (callback != null) {
                if (viewHolder == null) {
                    viewHolder = new DefaultDownloadViewHolder(downloadInfo);
                }
