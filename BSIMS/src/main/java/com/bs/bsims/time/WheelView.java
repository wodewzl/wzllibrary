...
public class WheelView extends View {
    ...
    private static final int VALUE_TEXT_COLOR = 0xFF009afe;
    ...
    private static int ADDITIONAL_ITEM_HEIGHT = 65;
