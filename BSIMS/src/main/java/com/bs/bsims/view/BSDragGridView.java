...
public class BSDragGridView extends GridView {
	/** ���ʱ���Xλ�� */
	public int downX;
	/** ���ʱ���Yλ�� */
	public int downY;
	...
	public BSDragGridView(Context context) {
		super(context);
		init(context);
	}

	public BSDragGridView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public BSDragGridView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
...
//		if (tempPostion != AdapterView.INVALID_POSITION) {
			...
			BossStatisticsDragAdapter  mDragAdapter = (BossStatisticsDragAdapter) getAdapter();
			//��ʾ���϶���ITEM
...
//				}
				...
				itemTotalCount = BSDragGridView.this.getCount();
...
//		this.windowParams.y = (y - this.win_view_y + this.viewY);//λ�õ�yֵ
	...
	private void hideDropItem() {
		((BossStatisticsDragAdapter) getAdapter()).setShowDropItem(false);
	}
