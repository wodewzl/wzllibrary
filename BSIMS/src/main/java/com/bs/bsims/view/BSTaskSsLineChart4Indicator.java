 ...
 * @author peck
 * @Description:
 * @date 2015-6-18 上午11:33:56
 * @email 971371860@qq.com
 * @version V1.0
 */

public class BSTaskSsLineChart4Indicator extends LinearLayout {

    private static final String TAG = "BSTaskSsLineChart4Indicator";
    ...
    public BSTaskSsLineChart4Indicator(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
    }

    public BSTaskSsLineChart4Indicator(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BSTaskSsLineChart4Indicator(Context context, AttributeSet attrs, int defStyle) {
        super(context);
        init(context);
    }
