...
/**
 * Single axis value, use it to manually set axis labels position. You can use label attribute to
 * display text instead of number but value formatter implementation have to handle it.
 */
public class AxisValue {
    ...
    public boolean equals(Object o) {
        ...
        if (Float.compare(axisValue.value, value) != 0)
            return false;
        if (!Arrays.equals(label, axisValue.label))
            return false;
