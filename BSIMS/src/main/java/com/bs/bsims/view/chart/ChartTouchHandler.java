...
import com.bs.bsims.view.chart.ChartScroller.ScrollResult;
...
public class ChartTouchHandler {
    ...
    /**
     * Computes scroll and zoom using {@link ChartScroller} and {@link ChartZoomer}. This method
     * returns true if scroll/zoom was computed and chart needs to be invalidated.
     */
    ...
    public boolean handleTouchEvent(MotionEvent event) {
        ...
        // TODO: detectors always return true, use class member needInvalidate instead local
        // variable as workaround.
    ...
    /**
     * Handle chart touch event(gestures, clicks). Return true if gesture was handled and chart
     * needs to be invalidated. If viewParent and containerScrollType are not null chart can be
     * scrolled and scaled within horizontal or vertical scroll container like ViewPager.
     */
