 ...
 */
@SuppressLint("NewApi")
public class BSCreativeIdeaSuggest extends LinearLayout {
    ...
    public BSCreativeIdeaSuggest(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public BSCreativeIdeaSuggest(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BSCreativeIdeaSuggest(Context context) {
        super(context);
        init(context);
    }
