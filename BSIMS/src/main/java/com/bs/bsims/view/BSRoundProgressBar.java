 ...
 * @author xiaanming
 */
public class BSRoundProgressBar extends View {
    /**
     * 画笔对象的引用
     */
    private Paint paint;
    ...
    public String status = "1";// 1为点击2为非点击状态3为透明颜色

    public BSRoundProgressBar(Context context) {
        this(context, null);
    }

    public BSRoundProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BSRoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if ("1".equals(status)) {
            ...
            paint.setColor(Color.parseColor("#00000000")); // 设置圆环的颜色
        }
