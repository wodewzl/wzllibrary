...
public class BSEmployeeRecord extends LinearLayout {
    ...
    public BSEmployeeRecord(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public BSEmployeeRecord(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BSEmployeeRecord(Context context) {
        super(context);
        init(context);
    }
