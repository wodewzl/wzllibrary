 ...
 */
@SuppressLint("NewApi")
public class BSDanganTotitle extends LinearLayout {

    private static final String TAG = "BSDanganTotitle";

    private List<CheckedTextView> mCheckedList = new ArrayList<CheckedTextView>();
    private List<View> mViewList = new ArrayList<View>();
    // // 顶部菜单的文字数组
    // private int[] mDrawableIds = new int[] { R.drawable.bg_letter,
    ...
    public BSDanganTotitle(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public BSDanganTotitle(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BSDanganTotitle(Context context) {
        super(context);
        init(context);
    }
    ...
    // 回调接口
    private DanganOnTopIndicatorListener mTabListener;

    public interface DanganOnTopIndicatorListener {
        void onIndicatorSelected(int index);
    }

    public void setDanganOnTopIndicatorListener(DanganOnTopIndicatorListener listener) {
