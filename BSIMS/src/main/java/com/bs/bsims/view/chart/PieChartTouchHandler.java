...
/**
 * Touch handler for PieChart. It doesn't handle zoom and scroll like default ChartTouchHandler.
 * Instead it uses Scroller(ScrollerCompat) directly to compute PieChart rotation when user scroll.
 * ChartScroller and ChartZoomer are not really used here.
 */
