...
/**
 * @author peck
 * @Description: 一、文档管理接口 首页
 * @date 2015-7-6 下午5:49:16
...
public class BSIndicator3Sharedfiles extends LinearLayout {
    ...
    private int[] mDrawableIds = new int[] {
            R.drawable.file_list_top_bgc1,
            R.drawable.file_list_top_bgc2, R.drawable.file_list_top_bgc3
    };
    ...
    public BSIndicator3Sharedfiles(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public BSIndicator3Sharedfiles(Context context, AttributeSet attrs) {
    ...
    public void setIndicator3SharedfilesListener(Indicator3SharedfilesListener listener) {
