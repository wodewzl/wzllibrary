...
public class PieChartData extends AbstractChartData {
     ...
     * set it to true you should also change chart fill ration using
     * {@link PieChartView#setCircleFillRatio(float)}. This flag is used only if you also set
     * hasLabels or hasLabelsOnlyForSelected flags.
     */
