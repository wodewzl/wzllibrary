...
public class ChartScroller {
    ...
    public boolean scroll(ChartComputator computator, float distanceX, float distanceY, ScrollResult scrollResult) {
        ...
        // Scrolling uses math based on the viewport (as opposed to math using pixels). Pixel offset
        // is the offset in
        // screen pixels, while viewport offset is the offset within the current viewport. For
        // additional
        // information on
        // surface sizes and pixel offsets, see the docs for {@link computeScrollSurfaceSize()}. For
        // additional
    ...
    public boolean fling(int velocityX, int velocityY, ChartComputator computator) {
        ...
        // TODO probably should be mScroller.forceFinish but ScrollerCompat doesn't have that
        // method.
        scroller.abortAnimation();
