...
/**
 * Single axis model. By default axis is auto-generated. Use {@link #setAutoGenerated(boolean)} to
 * disable axis values generation and set values manually using {@link #setValues(List)}. If Axis is
 * auto-generated {@link #setValues(List)} will be ignored but if you set some values Axis will
 * switch to manual mode. Change how axis labels are displayed by changing formatter
 * {@link #setFormatter(lecho.lib.hellocharts.formatter.AxisValueFormatter)}. Axis can have a name
 * that should be displayed next to labels(that depends on renderer implementation), you can change
...
public class Axis {
     ...
     * drawn outside), by default this is set to false and axis is drawn outside chart area.
     */
