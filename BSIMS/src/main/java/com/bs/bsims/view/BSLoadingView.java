 ...
 */
public class BSLoadingView extends FrameLayout {
    ...
    private static final String LOADINGCOLOR="#00A9FE";

    private BSShapeLoadingView mShapeLoadingView;
    ...
    public BSLoadingView(Context context) {
        super(context);
    }

    public BSLoadingView(Context context, AttributeSet attrs) {
    ...
    public BSLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//    }
    ...
    protected void onFinishInflate() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.bsload_view, null);
        ...
        mShapeLoadingView = (BSShapeLoadingView) view.findViewById(R.id.shapeLoadingView);

        mIndicationIm = (ImageView) view.findViewById(R.id.bs_indications);
    ...
    public void setText(CharSequence loadingText) {
        ...
        mLoadTextView.setTextColor(Color.parseColor(LOADINGCOLOR));
