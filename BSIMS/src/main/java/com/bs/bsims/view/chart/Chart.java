...
public interface Chart {
     ...
     * 500ms will be used. Before you call this method you should change target values of chart
     * data.
     */
     ...
     * set*ChartData method is called. If you disable viewports calculations viewports will not
     * change until you change them manually or enable calculations again. Disabled viewport
     * calculations is usefull if you want show only part of chart by setting custom viewport and
     * don't want any operation to change that viewport
     */
    public void setViewportCalculationEnabled(boolean isEnabled);

    /**
     * Set listener for data animation to be notified when data animation started and finished. By
     * default that flag is set to true so be careful with animation and custom viewports.
     */
    public void setDataAnimationListener(ChartAnimationListener animationListener);

    /**
     * Set listener for viewport animation to be notified when viewport animation started and
     * finished.
     */
    public void setViewportAnimationListener(ChartAnimationListener animationListener);

    /**
     * Set listener for current viewport changes. It will be called when viewport change either by
     * gesture or programmatically. Note! This method works only for preview charts. It is
     * intentionally disabled for other types of charts to avoid unnecessary method calls during
     * invalidation.
     */
    ...
    /**
     * Set true to allow user use touch gestures. If set to false user will not be able zoom, scroll
     * or select/touch value. By default true.
     */
    ...
    /**
     * Move/Srcoll viewport to position x,y(that position must be within maximum chart viewport). If
     * possible viewport will be centered at this point. Width and height of viewport will not be
     * modified.
     * 
    ...
    /**
     * Animate viewport to position x,y(that position must be within maximum chart viewport). If
     * possible viewport will be centered at this point. Width and height of viewport will not be
     * modified.
     * 
     * @see #setCurrentViewport(lecho.lib.hellocharts.model.Viewport) ;
    ...
    /**
     * Set zoom type, available options: ZoomType.HORIZONTAL_AND_VERTICAL, ZoomType.HORIZONTAL,
     * ZoomType.VERTICAL. By default HORIZONTAL_AND_VERTICAL.
     */
    ...
    /**
     * Programatically zoom chart to given point(viewport point). Call this method after chart data
     * had been set.
     * 
    ...
    /**
     * Programatically zoom chart to given point(viewport point) with animation. Call this method
    ...
    /**
     * Set true if you want allow user to click value on chart, set false to disable that option. By
     * default true.
     */
    public void setValueTouchEnabled(boolean isValueTouchEnabled);

    /**
     * Returns maximum viewport for this chart. Don't modify it directly, use
     * {@link #setMaximumViewport(Viewport)} instead.
     * 
    ...
    /**
     * Returns current viewport. Don't modify it directly, use {@link #setCurrentViewport(Viewport)}
     * instead.
     * 
    ...
    /**
     * Sets current viewport with animation. Note. viewport have to be set after chartData has been
     * set.
     */
    ...
    /**
     * Reset maximum viewport and current viewport. Values for both viewports will be
     * auto-calculated using current chart data ranges.
     */
     ...
     * somewhere else on the chart area. By default false and value is automatically unselected when
     * user stop pressing on it.
     */
    public void setValueSelectionEnabled(boolean isValueSelectionEnabled);

    /**
     * Select single value on chart. If indexes are not valid IndexOutOfBoundsException will be
     * thrown.
     */
    ...
    /**
     * Set isContainerScrollEnabled to true and containerScrollType to HORIZONTAL or VERTICAL if you
     * are using chart within scroll container.
     */
