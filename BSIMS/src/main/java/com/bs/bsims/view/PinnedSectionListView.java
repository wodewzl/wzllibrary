...
import com.bs.bsims.BuildConfig;
import com.bs.bsims.utils.CommonUtils;

public class PinnedSectionListView extends BSRefreshListView {
    ...
    void createPinnedShadow(int position) {
        ...
        ViewGroup pinnedView = (ViewGroup) getAdapter().getView(position, pinnedShadow.view, PinnedSectionListView.this);
        View pinedLayout = pinnedView.getChildAt(0);
        pinedLayout.setBackgroundColor(Color.parseColor("#eeeeee"));
        pinedLayout.setPadding(CommonUtils.dip2px(mContext, 15), CommonUtils.dip2px(mContext, 10), CommonUtils.dip2px(mContext, 10), CommonUtils.dip2px(mContext, 10));
    ...
    void ensureShadowForPosition(int sectionPosition, int firstVisibleItem, int visibleItemCount) {
        if (visibleItemCount < 1) { // no need for creating shadow at all, we have a single visible
                                    // item
            destroyPinnedShadow();
            return;
        }
