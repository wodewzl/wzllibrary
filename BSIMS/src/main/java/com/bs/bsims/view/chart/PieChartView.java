...
/**
 * PieChart is a little different than others charts. It doesn't have axes. It doesn't support
 * viewport so changing viewport wont work. Instead it support "Circle Oval". Pinch-to-Zoom and
 * double tap zoom wont work either. Instead of scroll there is chart rotation if
 * isChartRotationEnabled is set to true. PieChart looks the best when it has the same width and
...
public class PieChartView extends AbstractChartView implements PieChartDataProvider {
    ...
    /**
     * Use this to change pie chart area. Because by default CircleOval is calculated
     * onSizeChanged() you must call this method after size of PieChartView is calculated. In most
     * cases it will probably be easier to use {@link #setCircleFillRatio(float)} to change chart
     * area or just use view padding.
     */
    ...
    /**
     * Returns pie chart rotation, 0 rotation means that 0 degrees is at 3 o'clock. Don't confuse
     * with {@link View#getRotation()}.
     * 
     * @return
     */
    ...
    /**
     * Set false if you don't wont the chart to be rotated by touch gesture. Rotating
     * programmatically will still work.
     * 
     ...
     * Default is 1 so circle will have radius equals min(View.width, View.height).
     */
