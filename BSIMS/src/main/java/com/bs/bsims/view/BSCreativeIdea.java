 ...
 */
@SuppressLint("NewApi")
public class BSCreativeIdea extends LinearLayout {
    ...
    public BSCreativeIdea(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public BSCreativeIdea(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BSCreativeIdea(Context context) {
        super(context);
        init(context);
    }
