...
public class PieChartRenderer extends AbstractChartRenderer {
    ...
    public boolean checkTouch(float touchX, float touchY) {
        ...
        // Get touchAngle and align touch 0 degrees with chart 0 degrees, that why I subtracting
        // start angle,
        // adding 360
    ...
    /**
     * Method draws single slice from lastAngle to lastAngle+angle, if mode =
     * {@link #MODE_HIGHLIGHT} slice will be darken and will have bigger radius.
     */
    private void drawSlice(Canvas canvas, SliceValue sliceValue, float lastAngle, float angle, int mode) {
        ...
        if (MODE_HIGHLIGHT == mode) {
            // Add additional touch feedback by setting bigger radius for that slice and darken
            // color.
    ...
    /**
     * Viewport is not really important for PieChart, this kind of chart doesn't relay on viewport
     * but uses pixels coordinates instead. This method also calculates sum of all SliceValues.
     */
