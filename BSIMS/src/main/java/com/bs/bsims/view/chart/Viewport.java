 ...
 * Viewport holds 4 float coordinates for a chart extremes. The viewport is represented by the
 * coordinates of its 4 edges (left, top, right bottom). These fields can be accessed directly. Use
 * width() and height() to retrieve the viewport's width and height. Note: most methods do not check
 * to see that the coordinates are sorted correctly (i.e. left is less than right and bottom is less
 * than top). Viewport implements Parcerable.
 */
public class Viewport implements Parcelable {
    ...
    /**
     * Create a new viewport with the specified coordinates. Note: no range checking is performed,
     * so the caller must ensure that left is less than right and bottom is less than top.
     * 
    ...
    /**
     * Create a new viewport, initialized with the values in the specified viewport (which is left
     * unmodified).
     * 
    ...
    /**
     * @return the viewport's width. This does not check for a valid viewport (i.e.
     *         {@code left <= right}) so the result may be negative.
     */
    ...
    /**
     * @return the viewport's height. This does not check for a valid viewport (i.e.
     *         {@code top <= bottom}) so the result may be negative.
     */
    ...
    /**
     * @return the horizontal center of the viewport. This does not check for a valid viewport (i.e.
     *         {@code left <=
     * right})
     */
    ...
    /**
     * @return the vertical center of the viewport. This does not check for a valid viewport (i.e.
     *         {@code bottom <=
     * top})
     */
     ...
     * so it is up to the caller to ensure that {@code left <= right and bottom <= top}.
     * 
     * @param left The X coordinate of the left side of the viewport
     * @param top The Y coordinate of the top of the viewport
     * @param right The X coordinate of the right side of the viewport
    ...
    /**
     * Offset the viewport by adding dx to its left and right coordinates, and adding dy to its top
    ...
    /**
     * Offset the viewport to a specific (left, top) position, keeping its width and height the
     * same.
     * 
    ...
    /**
     * Inset the viewport by (dx,dy). If dx is positive, then the sides are moved inwards, making
     * the viewport narrower. If dx is negative, then the sides are moved outwards, making the
     * viewport wider. The same holds true for dy and the top and bottom.
     * 
     ...
     * {@code left <= x < right and bottom <= y < top}. An empty viewport never contains any point.
     * 
     * @param x The X coordinate of the point being tested for containment
     * @param y The Y coordinate of the point being tested for containment
     * @return true iff (x,y) are contained by the viewport, where containment means
     *         {@code left <= x < right and top <=
     * y < bottom}
     */
     ...
     * i.e. is this viewport a superset of the specified viewport. An empty viewport never contains
     * another viewport.
     * 
    ...
    /**
     * Returns true iff the specified viewport r is inside or equal to this viewport. An empty
     * viewport never contains another viewport.
     * 
    ...
    /**
     * Update this Viewport to enclose itself and the specified viewport. If the specified viewport
     * is empty, nothing is done. If this viewport is empty it is set to the specified viewport.
     * 
    ...
    /**
     * If the viewport specified by left,top,right,bottom intersects this viewport, return true and
     * set this viewport to that intersection, otherwise return false and do not change this
     * viewport. No check is performed to see if either viewport is empty. Note: To just test for
     ...
     * @return true if the specified viewport and this viewport intersect (and this viewport is then
     *         set to that intersection) else return false and do not change this viewport.
     */
    ...
    /**
     * If the specified viewport intersects this viewport, return true and set this viewport to that
     * intersection, otherwise return false and do not change this viewport. No check is performed
     * to see if either viewport is empty. To just test for intersection, use intersects()
     * 
    ...
    /**
     * Write this viewport to the specified parcel. To restore a viewport from a parcel, use
     * readFromParcel()
     * 
    ...
    /**
     * Set the viewport's coordinates from the data stored in the specified parcel. To write a
     * viewport to a parcel, call writeToParcel().
     * 
