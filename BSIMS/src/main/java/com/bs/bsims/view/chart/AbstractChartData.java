...
public abstract class AbstractChartData implements ChartData {
    ...
    /**
     * If true and {@link #isValueLabelBackgroundEnabled} is true each label will have background
     * rectangle and that rectangle will be filled with color specified for given value.
     */
    protected boolean isValueLabelBackgrountAuto = true;

    /**
     * If {@link #isValueLabelBackgroundEnabled} is true and {@link #isValueLabelBackgrountAuto} is
     * false each label will have background rectangle and that rectangle will be filled with this
     * color. Helpful if you want all labels to have the same background color.
     */
