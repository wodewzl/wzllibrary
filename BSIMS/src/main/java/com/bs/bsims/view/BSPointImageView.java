...
public class BSPointImageView extends ImageView {
    ...
    public BSPointImageView(Context context) {
        super(context);
        this.mContext = context;
    }

    public BSPointImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
    }

    public BSPointImageView(Context context, AttributeSet attrs, int defStyle) {
