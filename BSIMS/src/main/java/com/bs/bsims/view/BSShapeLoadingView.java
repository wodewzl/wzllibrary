 ...
 */
public class BSShapeLoadingView extends View {
    ...
    public BSShapeLoadingView(Context context) {
        super(context);
        init();
    }

    public BSShapeLoadingView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public BSShapeLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//    }
    ...
    private void init() {
        ...
        setBackgroundColor(getResources().getColor(R.color.none_color));
    }
