...
/**
 * android源码的写法，里面改动了部分源码
 * @author Administrator
 *
 */
public class YusAlertController{
    ...
    //默认的对话框布局ID
	public static int m_MyAlertContentViewId = R.layout.yus_alert_dialog; 
    ...
    public YusAlertController(Context context, DialogInterface di, Window window) {
        mContext = context;
        mDialogInterface = di;
        mWindow = window;
    ...
    private void setBackground(LinearLayout topPanel, LinearLayout contentPanel,
        ...
        int fullDark = R.drawable.yus_popup_full;
        int topDark = R.drawable.yus_popup_top;
        int centerDark = R.drawable.yus_popup_center;
        int bottomDark = R.drawable.yus_popup_bottom;
        int fullBright = R.drawable.yus_popup_full;
        int topBright = R.drawable.yus_popup_top;
        int centerBright = R.drawable.yus_popup_center;
        int bottomBright = R.drawable.yus_popup_bottom;
        int bottomMedium = R.drawable.yus_popup_bottom;
...
//        }
    ...
    public static class AlertParams {
        ...
        public void apply(YusAlertController dialog) {
            if (mCustomTitleView != null) {
        ...
        private void createListView(final YusAlertController dialog) {
            final RecycleListView listView = (RecycleListView)
                    mInflater.inflate(R.layout.yus_select_dialog, null);
            //TODO listView选择器
            //listView.setSelector(R.drawable.yus_bg_green);
            ...
            if (mIsMultiChoice) {
                if (mCursor == null) {
                    adapter = new ArrayAdapter<CharSequence>(
                            mContext, R.layout.yus_select_dialog_multichoice, android.R.id.text1, mItems) {
                        @Override
                    ...
                    adapter = new CursorAdapter(mContext, mCursor, false) {
                        ...
                        public View newView(Context context, Cursor cursor, ViewGroup parent) {
                            return mInflater.inflate(R.layout.yus_select_dialog_multichoice,
                                    parent, false);
                        }
                ...
                int layout = mIsSingleChoice 
                        ? R.layout.yus_select_dialog_singlechoice : R.layout.yus_select_dialog_item;
                if (mCursor == null) {
