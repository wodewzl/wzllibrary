...
package com.bs.bsims.ui.datepicker;
...
import com.bs.bsims.ui.datepicker.adapter.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.datepicker_wheelview_paint_setColor));
        // 设置线宽
