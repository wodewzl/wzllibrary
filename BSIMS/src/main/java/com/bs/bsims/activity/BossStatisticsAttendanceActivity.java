...
public class BossStatisticsAttendanceActivity extends BaseActivity implements OnTopIndicatorListener, OnClickListener, LineChartOnValueSelectListener, OnItemClickListener {
    ...
    private String mType = "1";// 1.缺卡，2缺日志，3迟到，4早退，5加班
    ...
    private BossStatisticsAttendanceAdapter mAttendanceAdapter;
    private TextView mDateTv, mNumberTv;
    private String mCurrentNumber = "0";
    private String mCrrentPeople = "0";
    private boolean mRefresh = true;// 控制每次请求数据是否完成
    ...
    public void initView() {
        ...
        mAttendanceAdapter = new BossStatisticsAttendanceAdapter(this);
    ...
    public boolean getData() {
        ...
        try {
            ...
            String jsonStrList = HttpClientUtil.getRequest(BSApplication.getInstance().getHttpTitle() + Constant.BOSS_STATISTICS_ATTENDANCE, mapList);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.txt_comm_head_right:
                CommonUtils.initPopViewBg(BossStatisticsAttendanceActivity.this, mArray, mOkTv, mCallback, mIcon);
                break;
            default:
                break;
        }
    ...
    ResultCallback mCallback = new ResultCallback() {
        ...
        public void callback(String str, int position) {
            ...
            if (position == 0) {
                ...
                intent.setClass(BossStatisticsAttendanceActivity.this, BossStatisticsAttendanceDistributedActivity.class);
                startActivity(intent);
            } else {
                intent.putExtra("title_name", mTitleTv.getText().toString() + "排行");
                intent.setClass(BossStatisticsAttendanceActivity.this, BossStatisticsAttendanceRankActivity.class);
                startActivity(intent);
            }
        }
    };
    ...
    public boolean getAllDepartByMonth() {
        ...
        try {
            ...
            mapList.put(Constant.FTOKEN_PARAMS, BSApplication.getInstance().getmCompany());
            String jsonStrList = HttpClientUtil.getRequest(BSApplication.getInstance().getHttpTitle() + Constant.BOSS_STATISTICS_ATTENDANCE_ALL, mapList);
            mAllAttendanceVO = gson.fromJson(jsonStrList, BossStatisticsAttendanceVO.class);
            if (Constant.RESULT_CODE.equals(mAllAttendanceVO.getCode())) {
                return true;
            }
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long id) {
        ...
        if (Integer.parseInt(mType) == 5) {
            ...
            intent.putExtra("type", mType);
            intent.setClass(this, EXTAttendanceStatisticsDepartmentEActivity.class);
