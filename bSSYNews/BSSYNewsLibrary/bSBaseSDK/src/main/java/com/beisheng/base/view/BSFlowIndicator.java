...
public class BSFlowIndicator extends View {
    private int count;
    ...
    public BSFlowIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.BSFlowIndicator);

        count = a.getInteger(R.styleable.BSFlowIndicator_count, 0);
        space = a.getDimension(R.styleable.BSFlowIndicator_space, 9);
        radius = a.getDimension(R.styleable.BSFlowIndicator_point_radius, 9);

        point_normal_color = a.getColor(
                R.styleable.BSFlowIndicator_point_normal_color, 0x000000);
        point_seleted_color = a.getColor(
                R.styleable.BSFlowIndicator_point_seleted_color, 0xffff07);
