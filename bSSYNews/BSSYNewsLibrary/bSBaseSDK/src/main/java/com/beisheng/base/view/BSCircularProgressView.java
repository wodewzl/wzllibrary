...
import com.beisheng.base.interfaces.CircularProgressViewListener;

import java.util.List;

@SuppressLint("NewApi")
public class BSCircularProgressView extends View {
    ...
    public BSCircularProgressView(Context context) {
        super(context);
        init(null, 0);
    }

    public BSCircularProgressView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public BSCircularProgressView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initAttributes(AttributeSet attrs, int defStyle)
    {
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.BSCircularProgressView, defStyle, 0);

        Resources resources = getResources();

        // Initialize attributes from styleable attributes
        currentProgress = a.getFloat(R.styleable.BSCircularProgressView_cpv_progress,
                resources.getInteger(R.integer.cpv_default_progress));
        maxProgress = a.getFloat(R.styleable.BSCircularProgressView_cpv_maxProgress,
                resources.getInteger(R.integer.cpv_default_max_progress));
        thickness = a.getDimensionPixelSize(R.styleable.BSCircularProgressView_cpv_thickness,
                resources.getDimensionPixelSize(R.dimen.cpv_default_thickness));
        isIndeterminate = a.getBoolean(R.styleable.BSCircularProgressView_cpv_indeterminate,
                resources.getBoolean(R.bool.cpv_default_is_indeterminate));
        autostartAnimation = a.getBoolean(R.styleable.BSCircularProgressView_cpv_animAutostart,
                resources.getBoolean(R.bool.cpv_default_anim_autostart));
        initialStartAngle = a.getFloat(R.styleable.BSCircularProgressView_cpv_startAngle,
        ...
        if (a.hasValue(R.styleable.BSCircularProgressView_cpv_color)) {
            color = a.getColor(R.styleable.BSCircularProgressView_cpv_color, resources.getColor(R.color.cpv_default_color));
        }
        ...
        animDuration = a.getInteger(R.styleable.BSCircularProgressView_cpv_animDuration,
                resources.getInteger(R.integer.cpv_default_anim_duration));
        animSwoopDuration = a.getInteger(R.styleable.BSCircularProgressView_cpv_animSwoopDuration,
                resources.getInteger(R.integer.cpv_default_anim_swoop_duration));
        animSyncDuration = a.getInteger(R.styleable.BSCircularProgressView_cpv_animSyncDuration,
                resources.getInteger(R.integer.cpv_default_anim_sync_duration));
        animSteps = a.getInteger(R.styleable.BSCircularProgressView_cpv_animSteps,
    ...
    /**
     * Sets whether this BSCircularProgressView is indeterminate or not. It will reset the animation
    ...
    /**
     * Starts the progress bar animation. (This is an alias of resetAnimation() so it does the same
     * thing.)
     */
