 ...
 */
public class BSReboundScrollView extends ScrollView {
	...
	public BSReboundScrollView(Context context) {
		super(context);
	}
	
	public BSReboundScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
