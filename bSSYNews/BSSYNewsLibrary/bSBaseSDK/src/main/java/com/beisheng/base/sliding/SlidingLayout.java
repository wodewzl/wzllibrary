...
package com.beisheng.base.sliding;
...
public class SlidingLayout extends ViewGroup {
    ...
    /**
     * No-op stubs for {@link com.chenjishi.slidedemo.base.SlidingLayout.SlideListener}. If you only
     * want to implement a subset of the listener methods you can extend this instead of implement
     * the full interface.
     */
    ...
    static class SlidingPanelLayoutImplJB extends SlidingPanelLayoutImplBase {
        /*
         * Private API hacks! Nasty! Bad! In Jellybean, some optimizations in the hardware UI
         * renderer prevent a changed Paint on a View using a hardware layer from having the
         * intended effect. This twiddles some internal bits on the view to force it to recreate the
         * display list.
         */
