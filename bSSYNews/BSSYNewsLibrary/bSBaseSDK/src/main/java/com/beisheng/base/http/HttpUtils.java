...
public class HttpUtils {
    ...
    public static String postByHttpClient(Context context, String strUrl,
        ...
        String result = HttpClientUtil.PostFromWebByHttpClient(context, strUrl, nameValuePairs);
        return result;
    }

    public static String getByHttpClient(Context context, String strUrl,
            NameValuePair... nameValuePairs) throws Exception {
        String result = HttpClientUtil.getFromWebByHttpClient(context, strUrl, nameValuePairs);
