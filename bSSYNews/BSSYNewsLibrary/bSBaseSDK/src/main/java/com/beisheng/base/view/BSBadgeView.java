 ...
 * @author Jeff Gilfelt
 */
public class BSBadgeView extends TextView {
	...
	public BSBadgeView(Context context, AttributeSet attrs) {
     ...
     */
	public BSBadgeView(Context context, View target) {
     ...
     */
	public BSBadgeView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}
	
	public BSBadgeView(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}
	
	public BSBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
