...
public class DragGrid extends GridView {
    ...
    public void init(Context context) {
        ...
        // 将布局文件中设置的间距dip转为px
        mHorizontalSpacing = BaseCommonUtils.dip2px(context, mHorizontalSpacing);
    }
    ...
    public void setOnItemClickListener(final MotionEvent ev) {
        setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view,
                ...
                ChannelItem.ListvBean.ListBeanX vo = (ChannelItem.ListvBean.ListBeanX) parent.getAdapter().getItem(position);
                ...
                // return false;
                // }
                if ("1".equals(vo.getFixed())&&"1".equals(vo.getIsdel())) {
                    return false;
                }
    ...
    public void OnMove(int x, int y) {
        ...
        if (dPosition > 1) {
            ...
            ChannelItem.ListvBean.ListBeanX vo = (ChannelItem.ListvBean.ListBeanX) this.getAdapter().getItem(dPosition);
            if ("1".equals(vo.getFixed())) {
                return;
            }
