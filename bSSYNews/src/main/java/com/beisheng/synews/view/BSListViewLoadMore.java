...
public class BSListViewLoadMore extends ListView implements OnScrollListener {
    private int lastItemIndex;// 当前ListView中最后一个Item的索引
    private LoadMoreListener loadMoreListener;
    private Context mContext;
    private LinearLayout mFooterLayout;

    public BSListViewLoadMore(Context context) {
        super(context);
    }

    public BSListViewLoadMore(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public BSListViewLoadMore(Context context, AttributeSet attrs, int defStyle) {
