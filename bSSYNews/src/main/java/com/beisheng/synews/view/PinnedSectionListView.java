...
public class PinnedSectionListView extends BSListViewLoadMore {
    ...
    void createPinnedShadow(int position) {
        ...
        pinedLayout.setPadding(BaseCommonUtils.dip2px(mContext, 10), BaseCommonUtils.dip2px(mContext, 10),
                BaseCommonUtils.dip2px(mContext, 10), BaseCommonUtils.dip2px(mContext, 10));
