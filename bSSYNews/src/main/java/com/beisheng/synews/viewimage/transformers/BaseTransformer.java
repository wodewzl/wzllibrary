...
import com.beisheng.synews.viewimage.animations.BaseAnimationInterface;
 ...
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}. After you call
 * setPageTransformer(), transformPage() will be called by
 * {@link com.example.androidimageslider.wedget.viewimage.Tricks.daimajia.slider.library.Tricks.ViewPagerEx}
 * when your slider are animating. In onPreTransform() function, that will make
 ...
 * work. if you want to make an acceptable transformer, please do not forget to extend from this
 * class.
 */
public abstract class BaseTransformer implements ViewPagerEx.PageTransformer {
     ...
     * true will set the visibility of the fragment to {@link View#GONE}. Returning false will force
     * the fragment to {@link View#VISIBLE}.
     * 
     * @return
     */
    ...
    /**
     * Called each {@link #transformPage(View, float)} call after {@link #onTransform(View, float)}
     * is finished.
     * 
     * @param view
     * @param position
