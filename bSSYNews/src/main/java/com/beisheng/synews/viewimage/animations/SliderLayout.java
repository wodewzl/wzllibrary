...
package com.beisheng.synews.viewimage.animations;
...
import com.beisheng.synews.viewimage.indicators.PagerIndicator;
import com.beisheng.synews.viewimage.slidertypes.BaseSliderView;
import com.beisheng.synews.viewimage.transformers.AccordionTransformer;
import com.beisheng.synews.viewimage.transformers.BackgroundToForegroundTransformer;
import com.beisheng.synews.viewimage.transformers.BaseTransformer;
import com.beisheng.synews.viewimage.transformers.CubeInTransformer;
import com.beisheng.synews.viewimage.transformers.DefaultTransformer;
import com.beisheng.synews.viewimage.transformers.DepthPageTransformer;
import com.beisheng.synews.viewimage.transformers.FadeTransformer;
import com.beisheng.synews.viewimage.transformers.FlipHorizontalTransformer;
import com.beisheng.synews.viewimage.transformers.FlipPageViewTransformer;
import com.beisheng.synews.viewimage.transformers.ForegroundToBackgroundTransformer;
import com.beisheng.synews.viewimage.transformers.RotateDownTransformer;
import com.beisheng.synews.viewimage.transformers.RotateUpTransformer;
import com.beisheng.synews.viewimage.transformers.StackTransformer;
import com.beisheng.synews.viewimage.transformers.TabletTransformer;
import com.beisheng.synews.viewimage.transformers.ZoomInTransformer;
import com.beisheng.synews.viewimage.transformers.ZoomOutSlideTransformer;
import com.beisheng.synews.viewimage.transformers.ZoomOutTransformer;
import com.beisheng.synews.viewimage.tricks.FixedSpeedScroller;
import com.beisheng.synews.viewimage.tricks.InfinitePagerAdapter;
import com.beisheng.synews.viewimage.tricks.InfiniteViewPager;
import com.beisheng.synews.viewimage.tricks.ViewPagerEx;
 ...
 * . There is some properties you can set in XML: indicator_visibility visible invisible
 * indicator_shape oval rect indicator_selected_color indicator_unselected_color
 * indicator_selected_drawable indicator_unselected_drawable pager_animation Default Accordion
 * Background2Foreground CubeIn DepthPage Fade FlipHorizontal FlipPage Foreground2Background
 * RotateDown RotateUp Stack Tablet ZoomIn ZoomOutSlide ZoomOut pager_animation_span
 */
public class SliderLayout extends RelativeLayout {
    ...
    private BSAutoSwipeRefreshLayout mSwipeRefreshLayout;
    private ImageView mPrveImg, mNextImg;
    ...
    public BSAutoSwipeRefreshLayout getmSwipeRefreshLayout() {
        return mSwipeRefreshLayout;
    }

    public void setmSwipeRefreshLayout(BSAutoSwipeRefreshLayout mSwipeRefreshLayout) {
        this.mSwipeRefreshLayout = mSwipeRefreshLayout;
    }

    public void setViewPagerSelect(int index) {
